...
my_shape7 = lx.add_shape("DEFINED_PROCESS", "3", 'd', my_shape6)
my_shape8 = lx.add_shape("ONE_PAGE_CONNECTOR", "4", 'd', my_shape7)
my_shape9 = lx.add_shape("MULTI_PAGE_CONNECTOR", "4", 'd', my_shape8)
lx.write_file()
